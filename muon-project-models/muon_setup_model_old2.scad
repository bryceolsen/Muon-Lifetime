// =============================================================
// MUON DETECTOR SETUP - beginner-friendly OpenSCAD version
// =============================================================
//
// IMPORTANT IDEA:
// OpenSCAD does NOT force any real-world unit system.
// It just uses numbers.
//
// So in this file, we will treat:
//     1 OpenSCAD unit = 1 inch
//
// That means all of your measurements can stay exactly as written.
// No inch() conversion function is needed.
//
// Example:
//     cube([10, 2, 1]);
// means a box that is 10 in long, 2 in wide, 1 in tall.
//
// -------------------------------------------------------------
