...
#   3. Candidate/sample of interest: coinc10 == 0 AND coinc11 == 0; neither the
#      first nor the second pulse had a coincidence in slab 3 (channel 2).
#   4. Background/control sample: coinc10 == 1 OR coinc11 == 1; either the
#      first or second pulse was coincident with slab 3 (used as a control/background sample)
...
run_label = "DiRPi33 Run66" # optional descriptive label for titles and filenames; if None, will try to infer from filename
...
output_plot = f"/Users/bryceolsen/Desktop/Stuart Lab/Muon Lifetime/3script/results2/{safe_label}_dt_background_subtraction_fit.png"
log_output = f"/Users/bryceolsen/Desktop/Stuart Lab/Muon Lifetime/3script/results2/{safe_label}_dt_background_subtraction_log.png"
subtracted_plot = f"/Users/bryceolsen/Desktop/Stuart Lab/Muon Lifetime/3script/results2/{safe_label}_dt_background_subtraction_only.png"
...
# require that at least one of the pulses was coincident with slab 3 (channel 2)
# this makes the event less like a stopped-muon candidate and suitable as a background/control
# select events where coinc10 == 1 OR coinc11 == 1
background_mask = base_cuts & ((coinc10 == 1) | (coinc11 == 1))
...
print("Background/control, coinc10 == 1 OR coinc11 == 1:", np.sum(background_mask))
...
#   that pass the quality cuts and the coincidence-selection (coinc10/coinc11).
...
plt.step(
    ...
    where="mid",
    linewidth=1.5,
    label=f"Scaled background: coinc10 = 1 or coinc11 = 1, scale={bg_scale:.3g}",
)
